    ...
    return (
        <>
            <section className="why">
                ...
                <p>Join us on our mission to create a more sustainable future, and trust that The Sustainable Kit is the right choice for you</p>
            </section>
        </>
    )
}
